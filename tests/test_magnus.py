...
from bnf.lieop.lie import combine, create_coords, lieoperator, liepoly
...
def test_rotation_addition(mu=-0.43, tol=1e-15):
    '''
    A simple test concerning the addition of angles when combining three Lie-operators.
    '''
    o1 = lieoperator(liepoly(a=[1], b=[1], value=mu), power=10)
    mu2 = mu/3
    o2 = lieoperator(liepoly(a=[1], b=[1], value=mu2), power=10)
    o222 = o2@o2@o2
