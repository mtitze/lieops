...
class lexp(lieoperator):
    ...
    def bch(self, *z, bch_minus_sign=-1, **kwargs):
        '''
        ...
        **kwargs
        ...
        comb, _, _ = combine(self.argument*bch_minus_sign, 
                             *[other.argument*bch_minus_sign for other in z], **kwargs)
        if len(comb) > 0:
            outp = sum(comb.values())*bch_minus_sign
